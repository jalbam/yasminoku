...
<html>
    <head>
        <title>Yasminoku &copy; (por Joan Alba Maldonado)</title>
                ...
                function reiniciar_juego()
                 {
                    ...
                    if (numeros_iniciales_provisional < 0 || numeros_iniciales_provisional > 81 || isNaN(numeros_iniciales_provisional))
                     {
                        alert("Los numeros iniciales elegidos no son validos. Debes poner un numero entre el 0 y el 81.");
                        document.getElementById("formulario_numeros_iniciales").numeros_iniciales.value = numeros_iniciales;
                        return false;
                     }
                    //Si se pulsa aceptar, se reinicia el juego:
                    else if (confirm("Pulsa aceptar para aplicar los cambios. Se perdera la partida actual."))
                     {
                         //Vuelve a mostrar la opcion predeterminada en el div de ver solucion:
                         document.getElementById("div_solucion").innerHTML = "ver soluci&oacute;n";
                         document.getElementById('div_solucion').title = 'Muestra el sudoku resuelto';
                         ver_solucion = false;
...
//                    numeros_solucionados--;
                    ...
                    if (ver_solucion)
                     {
                         ...
                         document.getElementById("div_solucion").innerHTML = "ocultar soluci&oacute;n";
                         document.getElementById('div_solucion').title = 'Oculta el sudoku resuelto';
                         for (j=1; j<=81; j++)
                          {
    ...
    <body onLoad="javascript:iniciar_juego_primera_vez();" onKeyPress="javascript:tecla_pulsada(event, 'onkeypress');" onKeyDown="javascript:tecla_pulsada(event, 'onkeydown');"  bgcolor="#efefef" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <!-- Ver solucion: -->
        <div id="div_solucion" title="Muestra el sudoku resuelto" style="visibility:visible; border:1px #aaaaaa dashed; background:#dddddd; color:#222222; left:10px; top:6px; width:140px; height:12px; padding:0px; position:absolute; font-size:11px; font-family:arial; font-weight:bold; line-height:11px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" onMouseOver="javascript:document.getElementById('div_solucion').style.color='#aa0000';" onMouseOut="javascript:document.getElementById('div_solucion').style.color='#222222';" onClick="javascript:mostrar_solucion();">ver soluci&oacute;n</div>
        <!-- Fin de Ver solucion. -->
        <!-- Intentar solucionar: -->
        <div id="div_solucionar" title="Intenta resolver el sudoku con los n&uacute;meros introducidos" style="visibility:visible; border:1px #aaaaaa dashed; background:#dddddd; color:#222222; left:160px; top:6px; width:140px; height:12px; padding:0px; position:absolute; font-size:11px; font-family:arial; font-weight:bold; line-height:11px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" onMouseOver="javascript:document.getElementById('div_solucionar').style.color='#aa0000';" onMouseOut="javascript:document.getElementById('div_solucionar').style.color='#222222';" onClick="javascript:intentar_solucionar();">intentar solucionar</div>
        ...
        <div id="div_menu_numeros" style="visibility:visible; border:2px #aaaaaa dashed; background:#dddddd; color:#000000; left:10px; top:482px; width:456px; height:36px; padding:0px; position:absolute; font-size:20px; line-height:20px; text-align:center; z-index:1;">
            <div id="opcion_1" style="visibility:visible; background:#dddddd; border:2px #bbbbbb dotted; color:#696969; left:10px; top:1px; width:26px; height:26px; padding:0px; position:absolute; font-size:26px; font-weight:bold; line-height:26px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" title="Elegir el n&uacute;mero 1" onMouseOver="javascript:seleccionar(1, 'activar', true);" onMouseOut="javascript:seleccionar(1, 'desactivar', false);" onClick="javascript:seleccionar(1, 'activar', false);">1</div>
            <div id="opcion_2" style="visibility:visible; background:#dddddd; border:2px #bbbbbb dotted; color:#696969; left:50px; top:1px; width:26px; height:26px; padding:0px; position:absolute; font-size:26px; font-weight:bold; line-height:26px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" title="Elegir el n&uacute;mero 2" onMouseOver="javascript:seleccionar(2, 'activar', true);" onMouseOut="javascript:seleccionar(2, 'desactivar', false);" onClick="javascript:seleccionar(2, 'activar', false);">2</div>
            <div id="opcion_3" style="visibility:visible; background:#dddddd; border:2px #bbbbbb dotted; color:#696969; left:90px; top:1px; width:26px; height:26px; padding:0px; position:absolute; font-size:26px; font-weight:bold; line-height:26px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" title="Elegir el n&uacute;mero 3" onMouseOver="javascript:seleccionar(3, 'activar', true);" onMouseOut="javascript:seleccionar(3, 'desactivar', false);" onClick="javascript:seleccionar(3, 'activar', false);">3</div>
            <div id="opcion_4" style="visibility:visible; background:#dddddd; border:2px #bbbbbb dotted; color:#696969; left:130px; top:1px; width:26px; height:26px; padding:0px; position:absolute; font-size:26px; font-weight:bold; line-height:26px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" title="Elegir el n&uacute;mero 4" onMouseOver="javascript:seleccionar(4, 'activar', true);" onMouseOut="javascript:seleccionar(4, 'desactivar', false);" onClick="javascript:seleccionar(4, 'activar', false);">4</div>
            <div id="opcion_5" style="visibility:visible; background:#dddddd; border:2px #bbbbbb dotted; color:#696969; left:170px; top:1px; width:26px; height:26px; padding:0px; position:absolute; font-size:26px; font-weight:bold; line-height:26px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" title="Elegir el n&uacute;mero 5" onMouseOver="javascript:seleccionar(5, 'activar', true);" onMouseOut="javascript:seleccionar(5, 'desactivar', false);" onClick="javascript:seleccionar(5, 'activar', false);">5</div>
            <div id="opcion_6" style="visibility:visible; background:#dddddd; border:2px #bbbbbb dotted; color:#696969; left:210px; top:1px; width:26px; height:26px; padding:0px; position:absolute; font-size:26px; font-weight:bold; line-height:26px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" title="Elegir el n&uacute;mero 6" onMouseOver="javascript:seleccionar(6, 'activar', true);" onMouseOut="javascript:seleccionar(6, 'desactivar', false);" onClick="javascript:seleccionar(6, 'activar', false);">6</div>
            <div id="opcion_7" style="visibility:visible; background:#dddddd; border:2px #bbbbbb dotted; color:#696969; left:250px; top:1px; width:26px; height:26px; padding:0px; position:absolute; font-size:26px; font-weight:bold; line-height:26px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" title="Elegir el n&uacute;mero 7" onMouseOver="javascript:seleccionar(7, 'activar', true);" onMouseOut="javascript:seleccionar(7, 'desactivar', false);" onClick="javascript:seleccionar(7, 'activar', false);">7</div>
            <div id="opcion_8" style="visibility:visible; background:#dddddd; border:2px #bbbbbb dotted; color:#696969; left:290px; top:1px; width:26px; height:26px; padding:0px; position:absolute; font-size:26px; font-weight:bold; line-height:26px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" title="Elegir el n&uacute;mero 8" onMouseOver="javascript:seleccionar(8, 'activar', true);" onMouseOut="javascript:seleccionar(8, 'desactivar', false);" onClick="javascript:seleccionar(8, 'activar', false);">8</div>
            <div id="opcion_9" style="visibility:visible; background:#dddddd; border:2px #bbbbbb dotted; color:#696969; left:330px; top:1px; width:26px; height:26px; padding:0px; position:absolute; font-size:26px; font-weight:bold; line-height:26px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" title="Elegir el n&uacute;mero 9" onMouseOver="javascript:seleccionar(9, 'activar', true);" onMouseOut="javascript:seleccionar(9, 'desactivar', false);" onClick="javascript:seleccionar(9, 'activar', false);">9</div>
            <div id="opcion_10" style="visibility:visible; background:#dddddd; border:2px #bbbbbb dotted; color:#696969; left:366px; top:6px; width:16px; height:16px; padding:0px; position:absolute; font-size:10px; font-weight:bold; line-height:16px; text-align:center; cursor: pointer; cursor: hand; z-index:2;" title="Borrar un n&uacute;mero" onMouseOver="javascript:seleccionar(10, 'activar', true);" onMouseOut="javascript:seleccionar(10, 'desactivar', false);" onClick="javascript:seleccionar(10, 'activar', false);">X</div>
            ...
            <div id="div_validar" style="visibility:visible; background:transparent; color:#000000; left:382px; top:6px; width:75px; height:26px; padding:0px; position:absolute; font-size:12px; font-weight:bold; line-height:12px; text-align:center; z-index:2;">
                <form id="validar" style="display:inline;">
                    <input type="button" value="Validar" name="boton_validar" style="font-size:12px; cursor: pointer; cursor: hand;" title="Comprobar si est&aacute; bien solucionado" onClick="javascript:validar_sudoku_usuario();">
                </form>
            </div>
        ...
        <div id="div_formulario_numeros_iniciales" style="visibility:visible; border:2px #aaaaaa dashed; background:#dddddd; color:#000000; left:10px; top:526px; width:456px; height:22px; padding:0px; position:absolute; font-size:20px; line-height:20px; text-align:center; z-index:1;">
            <form id="formulario_numeros_iniciales" style="display:inline;" onSubmit="javascript:reiniciar_juego(); return false;">
                <label for="numeros_iniciales" accesskey="c" style="cursor: pointer; cursor: hand;">
                    <u>C</u>antidad de n&uacute;meros iniciales: <input type="text" name="numeros_iniciales" style="font-size:12px; font-weight:bold; color:#444444; background:#efefef; text-align:center;" id="numeros_iniciales" value="28" maxlength="2" size="2" accesskey="c">
                </label>
                <input type="button" value="Crear" name="boton_crear" style="font-size:12px; cursor: pointer; cursor: hand;" title="Crear un nuevo sudoku" onClick="javascript:reiniciar_juego();">
            </form>
        </div>
        <!-- Fin de Formulario. -->
        <!-- Informacion: -->
        <div style="left:10px; top:560px; height:0px; position:absolute; border:0px; padding:0px; background:transparent; color:#333333; text-align:left; line-height:20px; text-decoration:none; font-family:verdana; font-size:10px; z-index:10;">
            &copy; <b>Yasminoku</b> 0.25a por <i>Joan Alba Maldonado</i> (<a href="mailto:granvino@granvino.com;">granvino@granvino.com</a>) &nbsp;<sup>(100% DHTML)</sup>
