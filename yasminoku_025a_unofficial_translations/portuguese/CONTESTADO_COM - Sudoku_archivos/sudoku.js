                ...
                function reiniciar_juego()
                 {
                    ...
                    else if (confirm("O jogo atual sera perdido!"))
                     {
                         //Vuelve a mostrar la opcion predeterminada en el div de ver solucion:
                         document.getElementById("div_solucion").innerHTML = "ver solucao";
                    ...
                    for (x=1; x<=81; x++)
                     {
                        ...
                        posicion_left = (numero_columna * tamanho) + 2 + espaciado_horizontal;
                        posicion_top = (numero_fila * tamanho) + 2 + espaciado_vertical;

                        //Se guarda el div como codigo HTML para insertarlo posteriormente:
                        codigo_html += '<div id="'+x+'" style="visibility:visible; background:'+color_fondo+'; color:#333333; left:'+posicion_left+'px; top:'+posicion_top+'px; width:'+tamanho+'px; height:'+tamanho+'px; padding:0px; position:absolute; font-size:18px; line-height:30px; text-align:center; cursor: pointer; cursor: hand; z-index:3;" onMouseOver="javascript:pintar_celda('+x+', \'activar\', true);" onMouseOut="javascript:pintar_celda('+x+', \'desactivar\', true);" onClick="javascript:pintar_celda('+x+', \'activar\', false);">' + x + '</div>';
                ...
                function validar_sudoku_usuario()
                 {
                    ...
                    if (!sudoku_completado) { alert("Precisa finalizar o jogo para valida-lo!"); }
                    //...pero si se han completado todos, se valida:
                    else
                     {
                        var sudoku_valido = validar_sudoku(true);
                        if (sudoku_valido) { alert("Parab&eacute;ns! Voc&ecirc; resolveu o jogo!"); } //Si es correcto, da la enhorabuena.
                        else { alert("N&atilde;o est&aacute; correto"); } //Si no, avisa.
                     }                    
                 }
                ...
                function mostrar_solucion()
                 {
                    ...
                    if (ver_solucion)
                     {
                         ...
                         if (!confirm("A solucao sera mostrada.\nPressione ok para ver"))
                          {
                         ...
                         document.getElementById("div_solucion").innerHTML = "esconder solu&ccedil;&atilde;o";
                         document.getElementById('div_solucion').title = 'Esconder resultado';
                         for (j=1; j<=81; j++)
                          {
                    ...
                    //...pero si se ha elegido ocultar, se oculta:
                    else
                     {
                         ...
                         document.getElementById("div_solucion").innerHTML = "ver solu&ccedil;&atilde;o";
                ...
                function intentar_solucionar()
                 {
                    ...
                    if (!confirm("O site tentar&aacute; resolver o jogo.\nAperte ok para prosseguir.")) { return; }
                    ...
                    if (sudoku_solucionado && sudoku_valido)
                     {
                        ...
                        alert("Sudoku resolvido.\nPressione ok para remover a solu&ccedil;&atilde;o.");
                        
                        //Se muestra el mensaje de cargando:
                        mostrar_mensaje("Inicializando...", true);
                    ...
                    else { mostrar_mensaje("", false); alert("Impossivel resolver."); }
